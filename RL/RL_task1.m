clc; clear; close all; load("task1.mat")
%% RL Variables
...
param=input('Enter a number (1-4) to choose one among the parameter values shown below: ');
dr=input('Enter an appropriate discount rate: '); % 0.5 or 0.9
% 1) param = 1/k;
% 2) param = 100/(100+k);
% 3) param = (1+log(k))/k;
% 4) param = (1+5*log(k))/k;
